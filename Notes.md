...
Where: Massachussets area or Northern NJ.

Who: Small to Medium businesses that would benefit from a website, dont have a website or need a new one. Ideas of industries to check: fire wood, plumbing, electricians, or literally anything.

Note/Hint: Dont only do this, but a helpful factor is to look for businesses that have and use their facebook page instead of a website and dont have their own website. This is a good starting spot, but also look for businesses that do have a website just need a revamp as it is out of date.

Output: Add on to CLientList.csv ensuring no duplicates.